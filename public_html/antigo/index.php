...
include_once("paginas/golaco.php");
...
<meta content='KJ GOL, Futebol, Futebol Online, Jogo, Futebol, Jogo de Navegador, Jogo de Browser, Jogo gratis, gratis, game, online game, corinthians, são paulo, palmeiras, flamengo, santos, botafogo, fluminense, vasco, internacional, grêmio, cruzeiro' name='keywords'>
...
<div style="position:absolute;top:23;left:53;top:30;width:170;height:160;background-image:url('img/logo.png');" id='logo'></div>
...
function tempo_restante(){
	...
	var tr_horas    = 18 - today.getHours();

	var tr_minutos  = 59 - today.getMinutes();

	var tr_segundos = 59 - today.getSeconds();
...
var te_hora_futuro = <?php echo $hora;?>;

var te_hora_hoje = <?php echo date("H");?>;
...
var te_minutos = <?php echo $minuto - date("i");?>;

var te_minutos = te_minutos * 60;

var te_segundos = <?php echo $segundo - date("s");?>;
...
<div id="tempo_chutar" style="position: absolute; top:70; left: 350;">
...
var te_hora_futuro1 = <?php echo $hora;?>;

var te_hora_hoje1 = <?php echo date("H");?>;
...
var te_minutos1 = <?php echo $minuto - date("i");?>;

var te_minutos1 = te_minutos1 * 60;

var te_segundos1 = <?php echo $segundo - date("s");?>;
...
<img src="img/<?php if($bola == 1){ ?>bola_1<?php }elseif($bola == 2){ ?>bola_2<?php }elseif($bola == 3){?>bola_3<?php }?>.png" width="54" height="54" style="cursor:pointer; position:absolute; top:55; left:59;" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" >
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
	  ...
	  $sql = DB::conn()->prepare("SELECT captcha,Penalti_Cod FROM usuarios WHERE ID = '".$_SESSION['ID']."'");
      ...
      <span class="spanHide">Digite os Caracteres da Imagem abaixo:</span>
                        ...
                        <div class="captchaFloat"><img src="captcha/captcha.php" /></div>
                           ...
                           <div class="inputFloat">
                        	...
                        	<input name="captcha" id="capt" type="text" class="txtImput" maxlength="4" />

                        </div><!--inputFloat-->

<input type="submit" value="Chutar" class="btn" id="captcha" /><br />

</form>

<span class="spanHide1" style="color:#F00;"></span>
...
event.preventDefault();
	...
	success: function(valor){
		...
		if(valor == 1){
			...
			$(".spanHide1").text('Codigo incorreto, tente novamente!');
			...
			var fo = new FlashObject("swf/penalti_v6.swf?cod=<?php echo $mc_cod;?>", "pnalti", "450", "338", "7", "#fff");
      ...
      <?php }else{ ?>
       ...
       <div id="penalti_swf">
         ...
         <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="450" height="338">
           ...
           <param name="movie" value="swf/penalti_v6.swf?cod=<?php echo $mc_cod;?>">
           ...
           <object type="application/x-shockwave-flash" data="swf/penalti_v6.swf?cod=<?php echo $mc_cod;?>" width="450" height="338">
...
<div id="tempo_chutar2" style="position: absolute; top:70; left: 495;">
...
var te_hora_futuro2 = <?php echo $hora;?>;

var te_hora_hoje2 = <?php echo date("H");?>;
...
var te_minutos2 = <?php echo $minuto - date("i");?>;

var te_minutos2 = te_minutos2 * 60;

var te_segundos2 = <?php echo $segundo - date("s");?>;
...
<img src="img/<?php if($bola == 1){ ?>bola_1<?php }elseif($bola == 2){ ?>bola_2<?php }elseif($bola == 3){?>bola_3<?php }?>.png" width="54" height="54" style="cursor:pointer; position:absolute; top:55; left:59;" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal1" >
...
<div class="modal-body">
	...
	<?php
	  ...
	  $sql = DB::conn()->prepare("SELECT captcha,Falta_Cod,Sorte FROM usuarios WHERE ID = '".$_SESSION['ID']."'");
      ...
      <span class="spanHide">Digite os Caracteres da Imagem abaixo:</span>
                        ...
                        <div class="captchaFloat"><img src="captcha/captcha.php" /></div>
                           ...
                           <div class="inputFloat">
                        	...
                        	<input name="captcha" id="capt2" type="text" class="txtImput" maxlength="4" />

                        </div><!--inputFloat-->

<input type="submit" value="Chutar" class="btn" id="captcha1" /><br />

</form>

<span class="spanHide2" style="color:#F00;"></span>

</div>

<div id="passe_certo_swf">
...
event.preventDefault();
	...
	url:'paginas/captcha2.php',

	data: {captcha2:captcha2},

	success: function(valor){

		if(valor == 1){

			$(".spanHide2").text('Codigo incorreto, tente novamente!');
			...
			<?php if($sorte == 1000){?>
				...
				var fo = new FlashObject("swf/passe_certo_sorte_v6.swf?cod=<?php echo $mc_cods;?>", "pcerto", "351", "416", "7", "#fff");
			...
			<?php }else{ ?>
				...
				var fo = new FlashObject("swf/passe_certo_v6.swf?cod=<?php echo $mc_cods;?>", "pcerto", "351", "416", "7", "#fff");
...
<td valign='top' align='center'><table cellpadding='0' cellspacing='0' border=0><tr><td><table cellpadding='0' cellspacing='0' border=0 height=20>
	...
	if(file_exists('paginas/' . $Paginas . '.php'))

		{

		require('paginas/' . $Paginas . '.php');

		}elseif(file_exists('adm/' . $Paginas . '.php')){

		require('adm/' . $Paginas . '.php');

		}elseif(file_exists('mod/'. $Paginas . '.php')){

		require('mod/'. $Paginas . '.php');	
