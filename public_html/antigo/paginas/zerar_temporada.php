...
$sql = DB::conn()->prepare("INSERT INTO top1_temporada (user_id) SELECT user_id '$medalha_1' FROM DUAL WHERE NOT EXISTS(SELECT user_id FROM top1_temporada)");
$sql->execute();
...
$sql = DB::conn()->prepare("INSERT INTO mensagens_usuario (id_de,id_para,Data,Hora,Conquista,Mensagem,Tipo,dinheiro,Nivel,Time) SELECT '$medalha_1', '$medalha_1', '$data', '$hora', '1', '0', 't', '30000', '0', '0' FROM DUAL WHERE NOT EXISTS(SELECT Data, Hora FROM mensagens_usuario WHERE Data = '$data' AND Hora = '$hora' AND id_de = '$medalha_1')");
$sql->execute();		
}else{
...
//verificar se n tiver nada na tabela ele inseri
if($ultimo->rowCount() == 0){
$sql = DB::conn()->prepare("INSERT INTO top2_temporada (user_id) SELECT user_id '$medalha_2' FROM DUAL WHERE NOT EXISTS(SELECT user_id FROM top2_temporada)");
$sql->execute();
...
$msg->execute();
$sql = DB::conn()->prepare("INSERT INTO mensagens_usuario (id_de,id_para,Data,Hora,Conquista,Mensagem,Tipo,dinheiro,Nivel,Time) SELECT '$medalha_2', '$medalha_2', '$data', '$hora', '2', '0', 't', '25000', '0', '0' FROM DUAL WHERE NOT EXISTS(SELECT Data, Hora FROM mensagens_usuario WHERE Data = '$data' AND Hora = '$hora' AND id_de = '$medalha_2')");
$sql->execute();	
}else{
$rs = $ultimo->fetchObject();
$ultimotop1 = $rs->user_id;
...
//verificar se n tiver nada na tabela ele inseri
if($ultimo->rowCount() == 0){
$sql = DB::conn()->prepare("INSERT INTO top3_temporada (user_id) SELECT user_id '$medalha_3' FROM DUAL WHERE NOT EXISTS(SELECT user_id FROM top3_temporada)");
$sql->execute();
...
$sql = DB::conn()->prepare("INSERT INTO mensagens_usuario (id_de,id_para,Data,Hora,Conquista,Mensagem,Tipo,dinheiro,Nivel,Time) SELECT '$medalha_3', '$medalha_3', '$data', '$hora', '3', '0', 't', '20000', '0', '0' FROM DUAL WHERE NOT EXISTS(SELECT Data, Hora FROM mensagens_usuario WHERE Data = '$data' AND Hora = '$hora' AND id_de = '$medalha_3')");
$sql->execute();	
}else{
$rs = $ultimo->fetchObject();
$ultimotop1 = $rs->user_id;
...
$sql = DB::conn()->prepare("INSERT INTO mensagens_usuario (id_de,id_para,Data,Hora,Conquista,Mensagem,Tipo,dinheiro,Nivel,Time) SELECT '$medalha_4', '$medalha_4', '$data', '$hora', '4', '0', 't', '15000', '0', '0' FROM DUAL WHERE NOT EXISTS(SELECT Data, Hora FROM mensagens_usuario WHERE Data = '$data' AND Hora = '$hora' AND id_de = '$medalha_4')");
$sql->execute();
}
...
$sql = DB::conn()->prepare("INSERT INTO mensagens_usuario (id_de,id_para,Data,Hora,Conquista,Mensagem,Tipo,dinheiro,Nivel,Time) SELECT '$medalha_5', '$medalha_5', '$data', '$hora', '5', '0', 't', '10000', '0', '0' FROM DUAL WHERE NOT EXISTS(SELECT Data, Hora FROM mensagens_usuario WHERE Data = '$data' AND Hora = '$hora' AND id_de = '$medalha_5')");
$sql->execute();	
}
...
$sql = DB::conn()->prepare("INSERT INTO mensagens_usuario (id_de,id_para,Data,Hora,Conquista,Mensagem,Tipo,dinheiro,Nivel,Time) SELECT '$medalha_6', '$medalha_6', '$data', '$hora', '6', '0', 't', '9000', '0', '0' FROM DUAL WHERE NOT EXISTS(SELECT Data, Hora FROM mensagens_usuario WHERE Data = '$data' AND Hora = '$hora' AND id_de = '$medalha_6')");
$sql->execute();			
}
...
$msg->execute();
$sql = DB::conn()->prepare("INSERT INTO mensagens_usuario (id_de,id_para,Data,Hora,Conquista,Mensagem,Tipo,dinheiro,Nivel,Time) SELECT '$medalha_7', '$medalha_7', '$data', '$hora', '7', '0', 't', '8000', '0', '0' FROM DUAL WHERE NOT EXISTS(SELECT Data, Hora FROM mensagens_usuario WHERE Data = '$data' AND Hora = '$hora' AND id_de = '$medalha_7')");
$sql->execute();		
}
...
$sql = DB::conn()->prepare("INSERT INTO mensagens_usuario (id_de,id_para,Data,Hora,Conquista,Mensagem,Tipo,dinheiro,Nivel,Time) SELECT '$medalha_8', '$medalha_8', '$data', '$hora', '8', '0', 't', '7000', '0', '0' FROM DUAL WHERE NOT EXISTS(SELECT Data, Hora FROM mensagens_usuario WHERE Data = '$data' AND Hora = '$hora' AND id_de = '$medalha_8')");
$sql->execute();		
}
...
$sql = DB::conn()->prepare("INSERT INTO mensagens_usuario (id_de,id_para,Data,Hora,Conquista,Mensagem,Tipo,dinheiro,Nivel,Time) SELECT '$medalha_9', '$medalha_9', '$data', '$hora', '9', '0', 't', '6000', '0', '0' FROM DUAL WHERE NOT EXISTS(SELECT Data, Hora FROM mensagens_usuario WHERE Data = '$data' AND Hora = '$hora' AND id_de = '$medalha_9')");
$sql->execute();	
}
...
$sql = DB::conn()->prepare("INSERT INTO mensagens_usuario (id_de,id_para,Data,Hora,Conquista,Mensagem,Tipo,dinheiro,Nivel,Time) SELECT '$medalha_10', '$medalha_10', '$data', '$hora', '10', '0', 't', '5000', '0', '0' FROM DUAL WHERE NOT EXISTS(SELECT Data, Hora FROM mensagens_usuario WHERE Data = '$data' AND Hora = '$hora' AND id_de = '$medalha_10')");
$sql->execute();		
}
