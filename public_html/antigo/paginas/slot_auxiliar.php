...
<center>
<div id="id_vips" style="font-family: Helvetica, sans-serif, Arial; font-size:16px; margin-bottom:5px;">Slots de Auxiliares</div>
...
if($cargos == 0 || $cargos == 4){
 ?>    
   ...
   <?php if($rs['Cargo'] == 4){ ?><img src='img/c4.png' border=0><?php }else{} ?>
   ...
   if($cargos == 4){
   ?>
    <a href="index.php?pr=remover_a&id_para=<?php echo $rs["ID"] ?>&id_de=<?php echo $id_de; ?>" style="color:#FFF; font-size:12px;">Remover</a>
    <?php }else{ ?>
     <a href="index.php?pr=auxiliar_add&id_para=<?php echo $rs["ID"] ?>&id_de=<?php echo $id_de; ?>" style="color:#FFF; font-size:12px;">Adicionar</a>
     <?php } ?>
    </span>
    </center>
    </td>
