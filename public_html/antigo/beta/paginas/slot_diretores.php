...
<center>
<div id="id_vips" style="font-family: Helvetica, sans-serif, Arial; font-size:16px; margin-bottom:5px;">Slots de Diretores</div>
...
?>
  ...
  <tr>
   ...
   <?php if($rs['Cargo'] == 2){ ?><img src='img/c2.png' border=0><?php }else{} ?>
   ...
   if($cargos == 2){
   ?>
    <a href="index.php?pr=remover_d&id_para=<?php echo $rs["ID"] ?>&id_de=<?php echo $id_de; ?>" style="color:#FFF; font-size:12px;">Remover</a>
    <?php }elseif($cargos == 1){ ?>
    
    <?php }else{ ?>
     <a href="index.php?pr=diretores_add&id_para=<?php echo $rs["ID"] ?>&id_de=<?php echo $id_de; ?>" style="color:#FFF; font-size:12px;">Adicionar</a>
     <?php } ?>
    </span>
    </center>
    </td>
