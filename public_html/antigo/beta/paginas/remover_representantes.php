...
if($Rodada >= 2){
echo '<script>alert("O prazo de remover representantes se esgotou !");location.href="index.php?pr=index"</script>';	
}else{
...
$sql = DB::conn()->prepare("UPDATE usuarios SET Representante = 0 WHERE ID = '$id_para'");
$sql->execute();
