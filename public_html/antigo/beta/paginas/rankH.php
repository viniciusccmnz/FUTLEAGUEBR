	...
	<tr><td><div style="position:relative;top:0;left:0;width:623;height:57;"><div style="width:623;height:57;background-image:url('img/layout/menu/topH.png');text-aling:center;"><div class="nosel" style="position:absolute;text-align:center;width:623;top:10;color:#515151;font-family:litoh;font-size:1em;">Ranking Hora</div><div style="position:absolute;text-align:center;width:623;top:9;color:#e8f4e1;font-family:litoh;font-size:1em;">Ranking Hora</div></div></div></td></tr>
...
$melhoreshora = DB::conn()->prepare("SELECT * FROM usuarios ORDER BY Gols_Hora DESC");
...
<img src='img/c1.png' border=0>
     <?php }else{} ?></td><td width='131'><?php echo $rs['Gols_Hora']; ?></td></tr><?php } ?></table>    
</div></div></td></tr>
