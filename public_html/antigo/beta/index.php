...
<div id="tempo_chutar" style="position: absolute; top:70; left: 390;">
...
<div id="tempo_chutar2" style="position: absolute; top:70; left: 300;">
...
<img src="img/<?php if($bola == 1){ ?>bola_1<?php }elseif($bola == 2){ ?>bola_2<?php }elseif($bola == 3){?>bola_3<?php }?>.png" width="54" height="54" style="cursor:pointer; position:absolute; top:55; left:59;" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modal-falta" onClick="Falta()" data-backdrop="static" >
...
var te_hora_futuro3 = <?php echo $hora;?>;

var te_hora_hoje3 = <?php echo date("H");?>;
...
var te_minutos3 = <?php echo $minuto3 - date("i");?>;

var te_minutos3 = te_minutos3 * 60;

var te_segundos3 = <?php echo $segundo3 - date("s");?>;
...
function temp_entretenimentos3() {
	  ...
	  <?php }else{?><?php }?>
		...
		var bola = '<img src="img/bola_'+text+'.png" width="54" height="54" style="cursor:pointer; position:absolute; top:10px; left:10px;" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal1" onClick="Trilha()"  >';

		  $("#divProgress3").prepend(bola);
